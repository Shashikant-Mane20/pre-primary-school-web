    ...
    <header className="sticky top-0 z-50 bg-white shadow-md border-b-4 border-blue-600">
      <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="flex items-center space-x-3">
          <img src="/images/logo.jpeg" alt="Seven Star Logo" className="h-12 w-12 object-contain" />
          <h1 className="text-xl font-bold text-blue-900">Seven Star Pre Primary School</h1>
        </div>
        ...
        <ul className={`${isOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-6 absolute md:static top-16 left-0 right-0 bg-white md:bg-transparent p-4 md:p-0`}>
